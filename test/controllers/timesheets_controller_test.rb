...
class TimesheetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create timesheet" do
    assert_difference('Timesheet.count') do
      post timesheets_url, params: { timesheet: { employee_id: @timesheet.employee_id, overtime: @timesheet.overtime, yearmonth: @timesheet.yearmonth } }
    end
  ...
  test "should update timesheet" do
    patch timesheet_url(@timesheet), params: { timesheet: { employee_id: @timesheet.employee_id, overtime: @timesheet.overtime, yearmonth: @timesheet.yearmonth } }
